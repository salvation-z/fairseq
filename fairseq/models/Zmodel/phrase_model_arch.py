...
# using phrase_transformer implement baseline
@register_model_architecture("phrase_transformer", "phrase_baseline")
...
@register_model_architecture("phrase_transformer", "phrase_encoder_mix")
def encoder_mix_architecture(args):
    # special arguments for phrase-level transformer
    args.phrase_decoder = getattr(args, 'phrase_decoder', False)
    args.gaussian_attention = getattr(args, 'gaussian_attention', True)
    args.multihead_attention = getattr(args, 'multihead_attention', True)
    # unnecessary args
    args.parse_function = getattr(args, 'parse_function', 'fixed_window')
    args.window_size = getattr(args, 'window_size', 3)
...
@register_model_architecture("phrase_transformer", "phrase_encoder_gauss")
def encoder_gauss_architecture(args):
    args.encoder_embed_path = getattr(args, "encoder_embed_path", None)
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 2048)
    args.encoder_layers = getattr(args, "encoder_layers", 6)
    ...
    args.phrase_decoder = getattr(args, 'phrase_decoder', False)
    args.gaussian_attention = getattr(args, 'gaussian_attention', True)
    args.multihead_attention = getattr(args, 'multihead_attention', False)
    # unnecessary args
    args.parse_function = getattr(args, 'parse_function', 'fixed_window')
    args.window_size = getattr(args, 'window_size', 3)
    args.generate_function = getattr(args, 'generate_function', 'max-pooling')
